  ...
  <transition name="newsList" mode="in-out">
    <div class="col-md-9">
      <div class="news-content ">
        <div>
          <el-carousel class="news-banner">
            <el-carousel-item v-for="(item, index) in newsList" :key="index" v-if="index<2">
            <div class="news-banner-img" v-html="item.cover" @click="showDetail(item)">
            </div>
          ...
          <div class="paging-wrapper" v-show="newsList.length > pageSize">
            <ul class="pagination">
              <li><a @click="page('last')" v-show='curPage>1'>上一页</a></li>
              ...
              <li><a @click="page('!last')" v-show="curPage<pageCount">下一页</a></li>
            </ul>
          </div>
        </div>
      </div>
